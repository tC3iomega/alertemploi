...
function JobSummary({ job, onView, onUpdateJobStatus, onUpdateLabels, onOpenUrl, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "w-full rounded-lg border border-muted p-4 lg:p-6", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-start justify-between gap-4 lg:gap-6", children: [(0, jsx_runtime_1.jsxs)("div", { children: [usedLink && ((0, jsx_runtime_1.jsxs)("a", { className: "flex items-center gap-2 text-sm text-muted-foreground", href: "#", onClick: (e) => {
                                ...
                                }, children: [(0, jsx_runtime_1.jsx)("img", { src: siteLogos[usedLink.site_id], alt: usedLink.title, className: "h-5" }), (0, jsx_runtime_1.jsxs)("span", { children: [" via ", usedLink.title] })] })), (0, jsx_runtime_1.jsx)("h1", { className: "mt-3 text-wrap font-medium lg:mt-4 lg:text-xl", children: job.title }), (0, jsx_runtime_1.jsxs)("p", { className: "text-sm text-muted-foreground", children: [job.companyName, job.location && ((0, jsx_runtime_1.jsxs)("span", { children: [" · ", job.location] }))] })] }), job.companyLogo && ((0, jsx_runtime_1.jsx)(avatar_1.Avatar, { className: "h-16 w-16", children: (0, jsx_runtime_1.jsx)(avatar_1.AvatarImage, { src: job.companyLogo }) }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-3 space-y-1.5 lg:mt-4", children: [job.jobType && ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-3 capitalize text-muted-foreground", children: [(0, jsx_runtime_1.jsx)(react_icons_1.BackpackIcon, { className: "h-4 w-4" }), job.jobType] })), job.salary && ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-3 text-muted-foreground", children: [(0, jsx_runtime_1.jsx)(react_icons_1.CookieIcon, { className: "h-4 w-4" }), job.salary] })), job.tags.length > 0 && ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-3 text-muted-foreground", children: [(0, jsx_runtime_1.jsx)(react_icons_1.ListBulletIcon, { className: "h-4 w-4" }), (0, jsx_runtime_1.jsx)("p", { className: "text-wrap", children: job.tags?.slice(0, 5).join(", ") })] }))] }), job.status === "excluded_by_advanced_matching" && job.exclude_reason && ((0, jsx_runtime_1.jsxs)("div", { className: "mt-6 rounded-md bg-destructive/10 p-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-2", children: [(0, jsx_runtime_1.jsx)(react_icons_1.InfoCircledIcon, { className: "h-auto w-5" }), (0, jsx_runtime_1.jsx)("p", { className: "font-medium", children: "Why was this job excluded?" })] }), (0, jsx_runtime_1.jsx)("p", { className: "mt-1", children: job.exclude_reason })] })), (0, jsx_runtime_1.jsxs)("div", { className: `mt-6 flex flex-col gap-2 sm:flex-row sm:justify-between ${job.status !== "excluded_by_advanced_matching" && "lg:mt-10"}`, children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex justify-between gap-2", children: [(0, jsx_runtime_1.jsx)(button_1.Button, { size: "lg", className: "w-24 text-sm", onClick: () => {
                                    onView(job);
                                }, children: "Open" }), job.status !== "applied" && ((0, jsx_runtime_1.jsx)(tooltip_1.TooltipProvider, { delayDuration: 500, children: (0, jsx_runtime_1.jsxs)(tooltip_1.Tooltip, { children: [(0, jsx_runtime_1.jsx)(tooltip_1.TooltipTrigger, { asChild: true, children: (0, jsx_runtime_1.jsx)(button_1.Button, { size: "lg", variant: "secondary", className: "w-10 border-none bg-border px-0 transition-colors duration-200 ease-in-out hover:bg-foreground/15 focus:bg-foreground/15", onClick: () => onUpdateJobStatus(job.id, "applied"), children: (0, jsx_runtime_1.jsx)(react_icons_1.CheckIcon, { className: "h-5 w-auto" }) }) }), (0, jsx_runtime_1.jsx)(tooltip_1.TooltipContent, { side: "bottom", className: "text-base", children: "Mark job as Applied" })] }) })), job.status !== "new" && ((0, jsx_runtime_1.jsx)(tooltip_1.TooltipProvider, { delayDuration: 500, children: (0, jsx_runtime_1.jsxs)(tooltip_1.Tooltip, { children: [(0, jsx_runtime_1.jsx)(tooltip_1.TooltipTrigger, { asChild: true, children: (0, jsx_runtime_1.jsx)(button_1.Button, { size: "lg", variant: "secondary", className: "w-10 border-none bg-border px-0 transition-colors duration-200 ease-in-out hover:bg-foreground/15 focus:bg-foreground/15", onClick: () => onUpdateJobStatus(job.id, "new"), children: (0, jsx_runtime_1.jsx)(react_icons_1.ResetIcon, { className: "h-4 w-auto" }) }) }), (0, jsx_runtime_1.jsx)(tooltip_1.TooltipContent, { side: "bottom", className: "text-base", children: "Move job back to New" })] }) })), job.status !== "archived" && ((0, jsx_runtime_1.jsx)(tooltip_1.TooltipProvider, { delayDuration: 500, children: (0, jsx_runtime_1.jsxs)(tooltip_1.Tooltip, { children: [(0, jsx_runtime_1.jsx)(tooltip_1.TooltipTrigger, { asChild: true, children: (0, jsx_runtime_1.jsx)(button_1.Button, { size: "lg", variant: "secondary", className: "w-10 border-none bg-border px-0 transition-colors duration-200 ease-in-out hover:bg-foreground/15 focus:bg-foreground/15", onClick: () => onUpdateJobStatus(job.id, "archived"), children: (0, jsx_runtime_1.jsx)(react_icons_1.ArchiveIcon, { className: "h-4 w-auto" }) }) }), (0, jsx_runtime_1.jsx)(tooltip_1.TooltipContent, { side: "bottom", className: "text-base", children: "Archive" })] }) })), (0, jsx_runtime_1.jsx)(tooltip_1.TooltipProvider, { delayDuration: 500, children: (0, jsx_runtime_1.jsxs)(tooltip_1.Tooltip, { children: [(0, jsx_runtime_1.jsx)(tooltip_1.TooltipTrigger, { asChild: true, children: (0, jsx_runtime_1.jsx)(button_1.Button, { size: "lg", variant: "secondary", className: "w-10 border-none bg-border px-0 transition-colors duration-200 ease-in-out hover:bg-foreground/15 focus:bg-foreground/15", onClick: (evt) => {
                                                    evt.stopPropagation();
...
function JobLabelSelector({ job, onUpdateLabels, className, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(select_1.Select, { value: label, onValueChange: (labelValue) => {
        ...
        }, children: [(0, jsx_runtime_1.jsx)(select_1.SelectTrigger, { className: (0, clsx_1.default)("h-10 w-[148px] focus:ring-0", className), children: (0, jsx_runtime_1.jsx)(select_1.SelectValue, { placeholder: "Add Label" }) }), (0, jsx_runtime_1.jsxs)(select_1.SelectContent, { children: [(0, jsx_runtime_1.jsx)(LabelOptionWithColor, { jobLabel: "None", colorClass: "bg-background" }), Object.values(core_1.JOB_LABELS).map((jobLabel) => ((0, jsx_runtime_1.jsx)(LabelOptionWithColor, { jobLabel: jobLabel, colorClass: labels_1.LABEL_COLOR_CLASSES[jobLabel] }, jobLabel)))] })] }));
}
