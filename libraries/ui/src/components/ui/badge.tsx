...
const badgeVariants = cva(
  "inline-flex items-center rounded-md w-fit border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary/15 text-foreground font-normal shadow hover:bg-primary/25 cursor-default",
        secondary:
        ...
        outline:
          "text-muted-foreground font-normal bg-transparent hover:bg-secondary cursor-default",
      },
    },
    defaultVariants: {
      variant: "default",
