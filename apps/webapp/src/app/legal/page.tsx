      ...
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <section style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 14, lineHeight: 1.8, color: 'var(--ae-text-body)' }}>
            ...
            Contact : <a href="mailto:contact@alertemploi.com" style={{ color: 'var(--ae-primary)' }}>contact@alertemploi.com</a>
          </p>
        </section>
        ...
        <section style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 14, lineHeight: 1.8, color: 'var(--ae-text-body)' }}>
            ...
            <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--ae-primary)' }}>vercel.com</a>
          </p>
        </section>
