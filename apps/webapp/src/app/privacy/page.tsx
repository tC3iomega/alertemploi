export default function ConfidentialitePage() {
  return (
    <main style={{
      ...
      fontFamily: 'Arial, Helvetica, sans-serif', color: 'var(--ae-text)',
      padding: '48px 24px',
    }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        <a href="/" style={{ fontSize: 13, color: 'var(--ae-primary)', textDecoration: 'none' }}>← Retour</a>
        
        <h1 style={{ fontSize: 28, fontWeight: 700, marginTop: 24, marginBottom: 8, letterSpacing: -0.5 }}>
          Politique de confidentialité
        </h1>
        <p style={{ fontSize: 13, color: 'var(--ae-text-muted)', marginBottom: 40 }}>Dernière mise à jour : juin 2025</p>
        ...
        <section style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 14, lineHeight: 1.8, color: 'var(--ae-text-body)' }}>
            ...
            <strong>Quentin Brugeille</strong> — <a href="mailto:contact@alertemploi.com" style={{ color: 'var(--ae-primary)' }}>contact@alertemploi.com</a>
          </p>
        </section>
        ...
        <section style={{ marginBottom: 36 }}>
          ...
          <ul style={{ fontSize: 14, lineHeight: 1.8, color: 'var(--ae-text-body)', paddingLeft: 20, marginTop: 8 }}>
        ...
        <section style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 14, lineHeight: 1.8, color: 'var(--ae-text-body)', marginTop: 12 }}>
            Pour exercer ces droits, contactez-nous à <a href="mailto:contact@alertemploi.com" style={{ color: 'var(--ae-primary)' }}>contact@alertemploi.com</a>. Vous pouvez également introduire une réclamation auprès de la <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--ae-primary)' }}>CNIL</a>.
          </p>
        </section>
        ...
        <section style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 14, lineHeight: 1.8, color: 'var(--ae-text-body)' }}>
            ...
            <a href="mailto:contact@alertemploi.com" style={{ color: 'var(--ae-primary)' }}>contact@alertemploi.com</a>
          </p>
        </section>
      </div>
    </main>
